...
namespace WeatherApp {
    internal class Program {
        ...
        private const string Url =
            "https://api.open-meteo.com/v1/forecast?latitude=50.0&longitude=50.0&current=temperature_2m,wind_speed_10m,relative_humidity_2m,apparent_temperature";
        ...
        static async Task Main(string[] args) {
            ...
            try {
                ...
                if (weather?.current != null) {
                    ...
                    Console.WriteLine($"体感温度：{weather.current.apparent_Temperature}℃");
                } else {
